...
void UI::list()
{
	...
	{
		cout << "title: " << this->controller.getRepository().getElements()[i].getTitle() << ", ";
		cout << "location: " << this->controller.getRepository().getElements()[i].getLocation() << ", ";
		cout << "timeOfCreation: " << this->controller.getRepository().getElements()[i].getTimeOfCreation() << ", ";
		cout << "timesAccessed: " << this->controller.getRepository().getElements()[i].getTimesAccessed() << ", ";
		cout << "footagePreview: " << this->controller.getRepository().getElements()[i].getFootagePreview() << "\n";
	}
